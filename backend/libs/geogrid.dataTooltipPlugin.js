...
L.DataTooltipPlugin = class DataTooltipPlugin extends L.ISEA3HLayerPlugin {
  onHover(e) {
    ...
    this._tooltip = L.polygon([[e.cell.lat, e.cell.lon]]).bindTooltip(`<b>value: ${(e.cell.value) ? e.cell.value.toFixed(2) : e.cell.value}</b><br/>lat, lon: ${e.cell.lat.toFixed(3)}°, ${e.cell.lon.toFixed(3)}°`, {
        offset: L.point(20, 0),
        direction: 'right',
        permanent: true,
        opacity: 1,
