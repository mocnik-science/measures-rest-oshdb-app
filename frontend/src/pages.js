...
const pages = [
  ...
  {path: '/measure/:id/description', label: null, component: PageItemMeasureDescription, exact: false, menu: false},
  {path: '/measure/:id/code', label: null, component: PageItemMeasureCode, exact: false, menu: false},
  {path: '/result', label: 'Results', component: PageItemResult, exact: true, menu: true},
  {path: '/result/:id/description', label: null, component: PageItemResultDescription, exact: false, menu: false},
  {path: '/context', label: 'Contexts', component: PageItemContext, exact: true, menu: true},
  {path: '/context/:id/description', label: null, component: PageItemContextDescription, exact: false, menu: false},
  {path: '/person', label: 'People', component: PageItemPerson, exact: true, menu: true},
  {path: '/person/:id/description', label: null, component: PageItemPersonDescription, exact: false, menu: false},
