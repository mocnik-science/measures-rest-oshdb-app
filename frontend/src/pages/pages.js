...
const pages = [
  ...
  {path: '/help/measureSOAP', label: 'Measures (SOAP code)', component: PageHelp, exact: true, menu: '/help'},
  {path: '/help/measureJAVA', label: 'Measures (JAVA code)', component: PageHelp, exact: true, menu: '/help'},
